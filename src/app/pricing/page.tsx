          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Schedule emails to send at the perfect time. Agent delivers them automatically."
              },
              {
                icon: Zap,
                title: "Automations (Pro)",
                description: "Set up recurring tasks on daily, weekly, or monthly schedules. Agent runs them automatically."
              },
              {
                icon: Globe,
