    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-6 bg-[#faf8f5] dark:bg-[#111113]">
        ...
        <p className="text-stone-500 dark:text-zinc-400 text-center max-w-md mb-4">
          Set up recurring tasks that Agent runs automatically — daily inbox cleanup, weekly stats, monthly unsubscribe sweeps, and more.
        </p>
        <Button
      ...
      <div className="max-w-3xl mx-auto p-4 sm:p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-stone-500 dark:text-zinc-400 mt-1">
              Recurring tasks that Agent runs automatically
            </p>
          </div>
          ...
          <div className="py-8">
            <div className="text-center mb-8">
              ...
              <p className="text-stone-500 dark:text-zinc-400 max-w-sm mx-auto mb-4 text-sm">
                Tell Agent what to automate and it handles the rest. Here are some ideas:
              </p>
        ...
        {tasks.length > 0 && (
          <div className="text-center mt-6">
            ...
            >
              Ask Agent to create more automations &#8594;
            </button>
          </div>
        )}
      </div>
