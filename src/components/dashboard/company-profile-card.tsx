    ...
    return (
      <Card className={`border-blue-200 dark:border-blue-900/40 bg-white dark:bg-zinc-900 overflow-hidden ${variant === 'full' ? '' : ''}`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-semibold text-stone-800 dark:text-zinc-200">
                {hasProfile ? 'Edit Company Profile' : 'Tell Agent about your company'}
              </h3>
              <p className="text-xs text-stone-500 dark:text-zinc-500">
                {hasProfile ? 'Update your info so Agent stays in sync' : 'Agent will use this to personalize every outreach, search, and draft'}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="cp-notes" className="text-xs font-medium text-stone-600 dark:text-zinc-400">Anything else Agent should know</Label>
            <textarea
              id="cp-notes"
              value={notes}
